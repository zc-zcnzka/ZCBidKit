// Dependency-free PNG -> square ICO (PNG-compressed entry).
...
if (!src || !out) { console.error('usage: node png2ico.cjs <src.png> <out.ico>'); process.exit(1); }
...
console.log('WROTE', out, 'canvas', T + 'x' + T, 'icoBytes', ico.length);
